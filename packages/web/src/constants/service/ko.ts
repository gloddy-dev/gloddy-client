...
2. '앱'이라 함은 '회사'가 '서비스'를 '회원'에게 제공하기 위해 정보통신설비를 이용하여 거래할 수 있도록 설
정한 모바일 안드로이드, IOS 환경의 앱, 즉 가상의 영업장을 의미합니다.
3. '이용자'란 이 약관에 따라 회사가 제공하는 서비스를 받는 '개인회원' 및 '비회원'을 말합니다.
4. '개인회원'은 회사에 개인정보를 제공하여 회원등록을 한 사람으로, 회사로부터 지속적으로 정보를 제공
받고 '회사'가 제공하는 서비스를 계속적으로 이용할 수 있는 자를 말합니다.
5. '비회원'은 '회원가입 전 단계의 자'를 의미합니다.
6. '휴대폰 인증'이라 함은 회원의 식별과 서비스이용을 위해 휴대폰 인증을 통한 신원확인이 이루어지며, 개인정보는 보안 목적으로 안전하게 처리됩니다. 7. ‘재학생 인증’은 회사가 제공하는 서비스를 받는 ‘개인회원’이 학교 이메일을 활용하여 신원 보호 및 서비스 보완을 강화하는 목적으로 제공되는 옵션이며, 필수 절차는 아닙니다.
8. '콘텐츠'란 정보통신망법의 규정에 따라 정보통신망에서 사용되는 부호·문자·음성·음향·이미지 또는 영상
등으로 정보 형태의 글, 사진, 동영상 및 각종 파일과 링크 등을 말합니다.
9. 매칭은 서비스 중 회원들이 취미와 관심사를 기반으로 일회성으로 진행하는 각종 온오프라인 모임 콘텐츠 및 제반 서비스를 의미합니다.
10. '호스트'란 매칭을 개설한 자를 의미합니다. 모임을 개설하기 위한 필수 정보를 기입하여 모임을 개설합니다. 지원서 승인을 통해 회원을 모집하여 모임 내 게시판을 통해 소통하며 정해진 날짜에 모임을 진행합니다.
11. '멤버'란 서비스 이용자 중에서 지원서를 작성해 해당 모임의 참여자로 승인된 자를 의미합니다.
12. '신뢰도 점수'란 다른 회원들이 본인에 대해 평가할 수 있는 매너 점수를 의미하며 신뢰도가 높을수록 모임 참여
에 있어 타 회원에게 좋은 이미지를 심어줄 수 있습니다.
13. '신뢰도 점수'를 구성하는 요소는 모임 중도 이탈 및 모임 결석, 모임 후 회원간 상호평가를 통해 얻은 데이터에 기반합니다.
14. 본 약관에서 정의하지 않는 용어는 관계법령이 정하는 바에 따르며, 그 외에는 일반적인 상견례를 따릅니다.

제3조(약관 외 준칙)
이 약관에서 정하지 아니한 사항에 대해서는 법령 또는 회사가 정한 서비스의 개별약관, 운영정책 및 규칙 등(이하 세부지침)의 규정에 따릅니다. 또한 본 약관과 세부지침이 충돌할 경우에는 세부지침에 따릅니다.

제4조(약관의 효력과 변경)
1. 이 약관은 Gloddy(이)가 제공하는 모든 인터넷서비스에 게시하여 공시합니다. 회사는 '전자상거래등에 서의 소비자보호에 관한 법률(이하 '전자상거래법'이라 함)', '약관의 규제에 관한 법률(이하' 약관규제 법'이라 함)', '정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 '정보통신망법'이라 함)' 등 본 서비스 와 관련된 법령에 위배되지 않는 범위에서 이 약관을 변경할 수 있으며, 회사는 약관이 변경되는 경우에 변경된 약관의 내용과 시행일을 정하여, 그 시행일로부터 최소 7일 (이용자에게 불리하거나 중대한 사항 의 변경은 30일) 이전부터 시행일 후 상당한 기간 동안 공지하고, 기존 이용자에게는 변경된 약관, 적용일 자 및 변경사유(변경될 내용 중 중요사항에 대한 설명을 포함)를 별도의 전자적 수단(전자우편, 문자메시지, 서비스 내 전자쪽지발송, 알림 메시지를 띄우는 등의 방법)으로 개별 통지합니다. 변경된 약관은 공지하거나 통지한 시행일로부터 효력이 발생합니다.
...
5. 서비스 이용을 승낙하지 아니하거나 유보한 경우, 회사는 원칙적으로 이를 서비스 이용 신청자에게 알리
도록 합니다. 단, 회사의 귀책사유 없이 이용자에게 알릴 수 없는 경우에는 예외로 합니다.
...
5. 회원의 '휴대폰 인증' 및 '재학생 인증' 정보에 관한 관리책임은 회원에게 있으며, 이를 제3가 이용하도록 해서는 안 됩니다.
6. 회사는 회원의 '휴대폰 인증' 또는 '재학생 인증' 정보가 개인정보 유출 우려가 있거나, 반사회적 또는 공서양속에 어긋나거나, 회사 또는 서비스의 운영자로 오인할 우려가 있는 경우, 해당 인증 정보의 이용을 제한할 수 있습니다.
7. 회원은 '휴대폰 인증' 또는 '재학생 인증' 정보가 도용되거나 제3자가 사용하고 있음을 인지한 경우에는 이를 즉시 회사에 통지하고 안내에 따라야 합니다.
8. 제3항의 경우 해당 회원이 회사에 그 사실을 통지하지 않거나, 통지하였으나 회사의 안내에 따르지 않아 발생한 불이익에 대하여 회사는 책임지지 않습니다.
...
제12조(이용자의 의무)
1. 이용자는 이용자가입을 통해 이용신청을 하는 경우 사실에 근거하여 신청서를 작성해야 합니다. 이용자가 허위, 또는 타인의 정보를 등록한 경우 회사에 대하여 일체의 권리를 주장할 수 없으며, 회사는 이로 인 하여 발생한 손해에 대하여 책임을 부담하지 않습니다.
...
3. 회사는 이용자의 청약철회, 해제 또는 해지의 의사표시를 수신한 후 그 사실을 이용자에게 회신합니다. 회 신은 이용자가 회사에 대하여 통지한 방법 중 하나에 의하고, 이용자가 회사에 대하여 통지한 연락처가 존재하지 않는 경우에는 회신하지 않을 수 있습니다.
...
2. 회사가 제공하는 서비스의 이용과 관련하여 회사의 운영정책 및 개인 정보 보호정책, 기타 서비스별 이용 약관에서
...
4. 회사는 '정보통신망법' 시행령에 따라 2년마다 영리목적의 광고성 정보 전송에 대한 수신동의 여부를 확인합니다.
...
가. 서비스 내에서 이용자가 작성한 콘텐츠의 복제, 수정, 전시, 전송, 배포 등 저작권을 침해하지 않는 범위 내의 2차적저작물 또는 편집 저작물 작성을 위한 사용. 다만, 해당 콘텐츠를 등록한 이용자가 해당 콘텐츠의 삭제 또는 사용 중지를 요청하는 경우 회사는 관련 법에 따라 보존해야하는 사항을 제외하고 관련 콘텐츠를 모두 삭제 또는 사용 지합니다.
...
제1조(시행일) 본 약관은 2023.09.01부터 시행됩니다.`;
